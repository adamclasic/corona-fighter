...
class LoosScene extends Scene {
  ...
  create() {
    ...
    let restartButton = this.add.dom(300, 600, 'button', "width: 300px; background-color: rgb(101, 166, 218); padding: 8px 16px; border-radius: 32px; border: 0; color: #1d0038; font-size: 32px;", 'REPLAY');
